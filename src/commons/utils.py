...
def convtrans2d(in_channels, out_channels, kernel_size, stride=1, padding=0, output_padding=0,
           dilation=1, groups=1, bias=True, padding_mode='zeros',
           weight_init='xavier'):
    
    m = nn.ConvTranspose2d(in_channels, out_channels, kernel_size, stride, padding, output_padding,
...
class ConvTrans2dBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, output_padding=0):
        ...
        self.m = convtrans2d(in_channels, out_channels, kernel_size, stride, padding, output_padding, 
                        bias=True, weight_init='kaiming')
...
class BlockLinear(nn.Module):
    def __init__(self, ninp, nout, k, bias=True, weight_init='xavier', gain=1.):
        ...
        if weight_init == 'kaiming':
            ...
            nn.init.xavier_uniform_(self.w, gain)
